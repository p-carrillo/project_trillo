import { projectRepositoryUrl } from '../content/public-docs';
  ...
  return (
    <main className="homepage alpha-access-page" aria-label="MonoTask alpha access page">
      ...
      <section className="alpha-access-hero" aria-labelledby="alpha-title">
        <div className="alpha-access-card">
          <p className="alpha-access-kicker">Private Alpha</p>
          <h1 id="alpha-title">MonoTask is currently in private alpha.</h1>
          <p>
            We are onboarding a limited number of developers. If you want alpha access, email us and include a short
            note about your project and toolchain.
          </p>
          <p>
            If you prefer, you can self-host MonoTask today using the public repository.
          </p>

          <div className="alpha-access-actions">
            <a className="alpha-access-email" href="mailto:hi@diteria.net">
              hi@diteria.net
            </a>

            <a
              className="alpha-access-repo"
